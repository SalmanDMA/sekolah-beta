      ...
      <div class="bg-white rounded-xl p-10 form-wrapper shadow-xl">
        <form @submit.prevent="submitForm">
          ...
          <div class="mt-6">
            <button
              type="submit"
              class="bg-orange-400 text-white px-4 py-2 rounded-md hover:bg-orange-600 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-300"
              :disabled="
                hasError('name') ||
                hasError('image') ||
                hasError('category') ||
...
<style scoped>
.error-input {
  @apply border-red-500  focus:outline-red-500;
}
